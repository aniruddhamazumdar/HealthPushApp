...
import com.healthpush.healthpushapp.common.PinnedSectionListView.PinnedSectionListAdapter;
...
public class SimpleSectionedListAdapter extends BaseAdapter implements PinnedSectionListAdapter{
    ...
    public static class Section {
        ...
        public Section(int firstPosition, CharSequence title, int resourceId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (isSectionHeaderPosition(position)) {
            ...
            int id = mSections.get(position).resourceId;
            return view;
